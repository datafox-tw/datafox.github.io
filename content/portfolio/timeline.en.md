...
Before ChatGPT emerged, I fully trained and deployed a sentiment classification system. This allowed me to truly understand the NLP pipeline (training → inference → deployment), marking a crucial starting point for my entry into the LLM / NLP field.
